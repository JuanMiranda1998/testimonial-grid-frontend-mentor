  ...
  return (
    <div className='max-w-[100vw] min-h-[100vlh] font-body overflow-hidden bg-[#edf2f8]'>
      <div className='grid grid-cols-1 lg:grid-cols-4 lg:grid-rows-2 gap-6 mx-5 mt-16 mb-6 md:mt-6'>
        <article className='lg:col-span-2 lg:row-start-1 lg:row-end-2 bg-[url("/images/bg-pattern-quotation.svg")] bg-no-repeat bg-[position:65%_2%] px-6 py-8 rounded-lg text-white bg-[#733fc8]'>
          ...
          <p className='text-sm lg:text-base text-[#cecece] opacity-70'>
